...
{
    $email = $_POST['email'];
    $sql = "SELECT COUNT(*) as counter FROM student WHERE email='$email'";
    ...
    try {
        ...
        $mail->Subject = 'Your Verification Code To Get Log In Credentials';
        ...
        $mail->send();
        header("Location: StudentForgotPassOTPVerify.php");
        exit();
    }
    catch (Exception $e) {
