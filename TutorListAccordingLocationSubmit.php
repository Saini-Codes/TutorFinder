...
$mail = new PHPMailer(true);
    ...
    try {
        ...
        $mail->send();
        echo "<body style='background: linear-gradient(to right, #ff9a9e, #fad0c4);'><div style='font-family: Arial, sans-serif; background-color: #ffdddd; color:rgb(255, 166, 0); padding: 20px; text-align: center; border-radius: 10px; max-width: 500px; margin: 50px auto;'><h3><a href='/TutorFinder/StudentProfile.php'>Search Another Tutor</a></h3></div>";
    } catch (Exception $e) {
