...
if ($result && $result->num_rows > 0) {
    ...
    $_SESSION['name'] = $row['username']; // used in profile
    $_SESSION['email'] = $row['email'];             // used in ApplyTeacher
    $_SESSION['password'] = $row['password'];       // used in some other checks

    showMessage("✅ Logged In Successfully!", "#4CAF50", "StudentProfile.php");
} else {
    showMessage("❌ Invalid Username or Password!", "#FF5722", "StudentLogIn.php");
}
